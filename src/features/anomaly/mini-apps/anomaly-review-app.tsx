...
function AnomalyReviewContainer({ context, onComplete, onBack, isReadOnly }: MiniAppProps) {
  ...
  const [edits, setEdits] = useState<Record<string, string>>(() => {
    const prior = context.stepOutputs['review'] as { edits?: Record<string, string> } | undefined
    return prior?.edits ?? {}
  })
  ...
  return (
    <AnomalyReviewView
      ...
      onEdit={(fieldJa, val) => setEdits((prev) => ({ ...prev, [fieldJa]: val }))}
...
export const AnomalyReviewApp = withWorkflowStep(AnomalyReviewContainer, { skeleton: 'review' })
