...
function AnomalyChartView({
  ...
  return (
    <div className="flex flex-col gap-5 p-6">
      ...
      <div className="rounded-xl border border-border bg-white p-4 h-52">
      ...
      {!isReadOnly && (
        <div className="flex justify-end">
          ...
          >
            データ確認へ <span className="text-primary/50">→</span>
          </button>
        </div>
      )}
    </div>
...
function AnomalyChartContainer({
  context,
  onComplete,
  isReadOnly,
}: MiniAppProps) {
